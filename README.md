...
The docker on first run will download the same version as tagged of SkyFactory 4 - 4.2.4 and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
